...
namespace NdGameSdk::ndlib::script {
	...
	InlineHook ScriptCFunc::InlinePatchCfunc(void* target_jmp, const wchar_t* source_name, const wchar_t* hook_name) {
		...
		if (CfuncHook) {
			spdlog::warn(
				fmt::runtime("InlineHook ScriptCFunc: {:#x} -> {:#x} ({:#x} -> {:#x}) | Hook target address: {:#x}"),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(this->GetFunc())),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(target_jmp)),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(source_name)),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(hook_name)),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(CfuncHook.target_address()))
			);
			return CfuncHook;
		}

		spdlog::error(
			fmt::runtime("Failed to InlineHook ScriptCFunc: {:#x} -> {:#x} ({:#x} -> {:#x})"),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(this->GetFunc())),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(target_jmp)),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(source_name)),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(hook_name))
	...
	MidHook ScriptCFunc::PatchCfunc(MidHookFn target_jmp, const wchar_t* source_name, const wchar_t* hook_name) {
		...
		if (CfuncHook) {
			spdlog::warn(
				fmt::runtime("MidHook ScriptCFunc: {:#x} -> {:#x} ({:#x} -> {:#x}) | Hook target address: {:#x}"),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(this->GetFunc())),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(target_jmp)),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(source_name)),
				static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(hook_name)),
		...
		spdlog::error(
			fmt::runtime("Failed to MidHook ScriptCFunc: {:#x} -> {:#x} ({:#x} -> {:#x})"),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(this->GetFunc())),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(target_jmp)),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(source_name)),
			static_cast<uintptr_t>(reinterpret_cast<uintptr_t>(hook_name))

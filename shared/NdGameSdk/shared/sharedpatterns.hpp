...
namespace NdGameSdk::Patterns {
	...
	static inline const SdkPattern CommonGame_CommonGameLoop_GameDebugUpdate = { L"48 8d 4d 08 e8 ?? ?? ?? ?? c7 44 24 30 01 00 00 00 4c 89 7c 24 28 c7 44 24 20 15 15 00 00 4c 8d 0d ?? ?? ?? ?? 33 d2 44 8d 42 03 48 8d 0d", +0x51 };

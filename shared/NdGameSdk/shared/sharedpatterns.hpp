...
namespace NdGameSdk::Patterns {
	...
	static inline const SdkPattern CommonGame_NxAppHooks_NxApp_Init = { L"48 83 ec 28 48 83 3d ?? ?? ?? ?? 00 74 07 32 c0 48 83 c4 28 c3 48 89 0d ?? ?? ?? ?? 48 85 c9 74 0d 48 8b 01 ba 18 01 00 00 ff 50 08 eb 0a b9 18 01 00 00 e8 ?? ?? ?? ?? 33 d2 48 89 05" };
	static inline const SdkPattern CommonGame_NxAppHooks_NxApp = { CommonGame_NxAppHooks_NxApp_Init.pattern, +0x4 };
	static inline const SdkPattern CommonGame_NxAppHooks_Init1of2 = { L"48 89 5c 24 08 48 89 74 24 10 48 89 7c 24 18 55 41 56 41 57 48 8d ac 24 60 fa ff ff 48 81 ec a0 06 00 00 48 8b 05 ?? ?? ?? ?? 48 33 c4 48 89 85 98 05" };
	...
	static inline const SdkPattern FileSystem_Init = { L"48 89 5c 24 10 48 89 74 24 18 55 57 41 54 41 56 41 57 48 8d 6c 24 c9 48 81 ec 00 01 00 00 48 8b 05 ?? ?? ?? ?? 48 33 c4 48 89 45 2f 4c 8b f9 80 b9 e0 00 00 00 00 0f 85 ?? ?? ?? ?? 33 d2 33 c9 e8 ?? ?? ?? ?? b9 50 00 00 00" };

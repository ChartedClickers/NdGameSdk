...
namespace NdGameSdk::DB {
    ...
    inline void FlushFile(const std::string& /*file*/)
    {
        // Flush underlying store if needed; current database implementation likely syncs on commit.
        // Placeholder using system call to keep previous semantics.
